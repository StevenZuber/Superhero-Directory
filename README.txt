...
Technologies used include Java, Spring MVC, basic jsp, and html/css. The css is rather simple and doesn't utilize a bootstrap. I used an array list instead of a hashmap.
